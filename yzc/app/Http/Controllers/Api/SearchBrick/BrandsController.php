...
class BrandsController extends Controller
{
    ...
    public function brandEvaluate()
    {
        ...
        $res->list = $this->brand_evaluate
            ->select(['users_name','users_img','content','grade','brand_id','created_at'])
    ...
    public function setBrandEvaluate()
    {
        ...
        $userInfo = Users::select(['name','img'])->where(['id'=>$data['users_id']])->first();
        unset($data['users_id'],$data['api_token']);
        $data['users_name'] = $userInfo->name;
        $data['users_img'] = $userInfo->img;
